...
fn bls_generate_key_from_seed_test() {
    ...
    assert_eq!(public_key, vec![149, 24, 232, 64, 238, 67, 137, 51, 92, 227, 233, 238, 58, 35, 223, 100, 195, 189, 17, 242, 44, 153, 122, 144, 111, 191, 114, 124, 139, 70, 100, 94, 44, 208, 180, 7, 166, 249, 39, 2, 13, 122, 33, 79, 243, 88, 21, 131, 22, 190, 29, 71, 249, 100, 255, 84, 14, 119, 216, 41, 28, 16, 141, 143, 252, 125, 76, 186, 53, 50, 194, 103, 53, 66, 249, 172, 78, 75, 126, 29, 72, 215, 10, 15, 221, 120, 205, 169, 86, 111, 74, 240, 31, 87, 160, 155]);
    assert_eq!(secret_key.len(), 32);
    assert_eq!(secret_key, vec![79, 39, 150, 177, 236, 152, 132, 139, 85, 146, 82, 139, 146, 192, 245, 41, 220, 2, 193, 129, 84, 175, 137, 116, 174, 202, 242, 90, 167, 29, 75, 1]);
}
